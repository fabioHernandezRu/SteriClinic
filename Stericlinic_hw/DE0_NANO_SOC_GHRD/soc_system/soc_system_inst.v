	soc_system u0 (
		...
		.clearfifonios_export                  (<connected-to-clearfifonios_export>),                  //                  clearfifonios.export
		.clk_clk                               (<connected-to-clk_clk>),                               //                            clk.clk
		.data_arm2nios_export                  (<connected-to-data_arm2nios_export>),                  //                  data_arm2nios.export
		.data_arm2nios_in_export               (<connected-to-data_arm2nios_in_export>),               //               data_arm2nios_in.export
		.data_arm2nios_sel_export              (<connected-to-data_arm2nios_sel_export>),              //              data_arm2nios_sel.export
		.data_arm2nios_wr_export               (<connected-to-data_arm2nios_wr_export>),               //               data_arm2nios_wr.export
		...
		.fifo_fromnios_export                  (<connected-to-fifo_fromnios_export>),                  //                  fifo_fromnios.export
		...
		.not_emptyniosfifo_export              (<connected-to-not_emptyniosfifo_export>),              //              not_emptyniosfifo.export
		...
		.read_fifo_export                      (<connected-to-read_fifo_export>)                       //                      read_fifo.export
	);
